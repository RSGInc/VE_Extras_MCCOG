...
for(Year in getYears()) {
  ...
  runModule("CalculateCarbonIntensity",        "VEPowertrainsAndFuelsIndy", RunFor = "AllYears",    RunYear = Year)
  runModule("AssignHhVehiclePowertrain",       "VEPowertrainsAndFuelsIndy", RunFor = "AllYears",    RunYear = Year)
  for (i in 1:2) {
